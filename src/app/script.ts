                              ...
                              "steps": [
                                {
                                  "say": {
                                    ".tx": {
                                      "_": "האם מקום המגורים הנוכחי שלך הוא דיור מוגן?",
                                      "ar": "هل مكان سكنك الحالي هو مسكن للرعاية؟",
                                      "en": "Do you currently live in an assisted living complex?",
                                    ...
                                    "options": [
                                      {
                                        "show": {
                                          ".tx": {
                                            "_": "כן, דיור מוגן",
                                            "ar": "نعم, مسكن للرعاية",
                                            "en": "Yes, assisted living complex",
                        ...
                        "switch": {
                          ...
                          "cases": [
                            ...
                            },
                            {
                              "steps": [
                                {
                                  "say": "אם הנך לומד בבית-ספר או מוסד חינוכי אחר, מה שמו?",
                                  "uid": "134c074a20"
                                },
                                {
                                  "uid": "6f0065690c",
                    ...
                    "steps": [
                      {
                        "say": {
                          ".tx": {
                            ...
                            "ar": "في آخر إستبيان ذكرت انك قمت بفحص للكورونا.. هل وصلتك نتيجة الفحص؟",
                        ...
                        "wait": {
                          "options": [
                            ...
                            },
                            {
                              "show": {
                                ".tx": {
                                  "_": "אני חולה בקורונה (מאומת בבדיקת מעבדה)",
                                  "ar": "أنا مُصاب/ة بالكورونا (مؤكد بفحص مختبر)",
                              ...
                              "steps": [
                                {
                                  "say": {
                                    ".tx": {
                                      ...
                                      "es": "¿Saliste de casa la semana pasada?",
                                                            ...
                                                            "steps": [
                                                              {
                                                                "say": {
                                                                  ".tx": {
                                                                    "_": "האם ביקור בבית תפילה הוא חלק מהשיגרה שלך?",
                                                                    "ar": "هل زيارة أماكن الصلاة هو جزء من عاداتك؟",
                                                                    "en": "Is visiting a prayer house part of your routine?",
                                                                    "es": "¿Visitar una casa de oración o templo es parte de tu rutina?",
                                                                    "fr": "La visite d'un lieu de prière fait-elle partie de votre routine ?",
                                                                    "ru": "Посещаете ли вы обычно молитвенный дом?"
                                                                  }
                                                                },
                                                                "uid": "6ab9910b0e"
                                                              }
                                                            ...
                                                            "steps": [
                                                              {
                                                                "say": {
                                                                  ".tx": {
                                                                    "_": "האם אתה נוהג לבקר בבית תפילה באופן קבוע?",
                                                                    "ar": "هل تقوم بزيارة أماكن الصلاة بشكل دائم؟",
                                                                    "en": "Do you visit a prayer house regularly?",
                                                                    "es": "¿Visita un templo regularmente?",
                                                                    "fr": "Visitez-vous régulièrement un lieu de prière ?",
                                                                    "ru": "Посещаете ли вы молитвенный дом постоянно?"
                                                                  }
                                                                },
                                                                "uid": "2db8016a4a"
                                                              }
                                                            ...
                                                            "steps": [
                                                              {
                                                                "say": {
                                                                  ".tx": {
                                                                    "_": "האם את נוהגת לבקר בבית תפילה באופן קבוע?",
                                                                    "ar": "هل تقومين بزيارة أماكن الصلاة بشكل دائم؟",
                                                                    "en": "Do you visit a prayer house regularly?",
                                                                    "es": "¿Visita una templo regularmente?",
                                                                    "fr": "Visitez-vous régulièrement un lieu de prière ?",
                                                                    "ru": "Посещаете ли вы молитвенный дом постоянно?"
                                                                  }
                                                                },
                    ...
                    "steps": [
                      {
                        "say": {
                          ".tx": {
                            ...
                            "ar": "بالرغم من انك ذكرت سابقا أنك تشعر/ين بتحسن, لكن من المستحسن في هذه الفترة متابعة درجة حرارة الجسم بشكل يومي.",
